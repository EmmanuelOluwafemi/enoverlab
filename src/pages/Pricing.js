        ...
        <StyledPricingWrapper>
             <div className="adbox">
                ...
                <div className="text-box-3">
                    <p className='web-text'> Classses start on the 10th of August<br/>  <span>Enroll below</span></p>
                    <p className='mobile-text'>Classes start on the 10th of August<br/><span>Enroll below</span></p>
                </div>
            </div>
            <Header />
            <StyledPricing>
