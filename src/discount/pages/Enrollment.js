...
const Contact = () => {
    ...
    const scriptUrl = "https://script.google.com/macros/s/AKfycbzftSAq7FzfN6NuJpTU_l_rRUWw6eJgj_5aazNAcRGVjXlnj6Tf8-E1UWQQJMhCM9Kh/exec";
    ...
    const options = [
        { value: 'basic', label: 'Basic - (₦24,000 for 4 weeks)' },
        { value: 'premium', label: 'Premium - (₦80,000 for 10 weeks)' },
    ]
        ...
        <>
            ...
            >
                <h4
                    ...
                    data-aos-delay="1200"
                >
                    INSTALLMENT <br /> PAYMENT IS ALLOWED
                </h4>
                <div 
                    className="holder"
                    data-aos="fade-right" 
